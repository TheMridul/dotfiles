---
name: tdd
description: "Use for an explicit TDD or regression-test request, or a bug with an obvious, cheap local test path. Skip when testing needs costly or unclear setup."
---
